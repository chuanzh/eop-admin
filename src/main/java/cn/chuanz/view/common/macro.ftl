...
<div class="row">
	<div class="col-xs-6">
		<div class="dataTables_info" id="dynamic-table_info" role="status" aria-live="polite">
			total count：${pagerTool.totalCount!}，page size： ${pagerTool.pageSize!}， page count：${pagerTool.pagerCount!}
		</div>
	</div>
		...
		<div class="dataTables_paginate paging_simple_numbers" id="dynamic-table_paginate">
			<ul class="pagination">
				<li class="paginate_button previous" aria-controls="dynamic-table" tabindex="0" id="dynamic-table_previous">
					<a onclick="goto_BeforePager('1')" href="javascript:void(0);">home</a></li>
				...
				<li class="paginate_button next" aria-controls="dynamic-table" tabindex="0" id="dynamic-table_next">
					<a onclick="goto_NextPager('${pagerTool.pagerCount}')" href="javascript:void(0);">end→${pagerTool.pagerCount!}</a></li>
			</ul>
		</div>
	</div>
</div>
